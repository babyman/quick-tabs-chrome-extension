...
2019.12.29 - **Quick Tabs turns 10!**, added new commands '/close', '/merge', '/split' and '/reload', '/w' to search tabs in the current window only, also allow specifying the search engine as part of the query (/fuzzy, /fuse, /regex, /subs) 
